<div>
    ...
    <div class="flex flex-row sm:flex-col md:flex-row  gap-4">
        ...
        <div class="md:w-6/12 lg:w-6/12 sm:w-full">
            <div class="card card-compact w-full bg-base-100 shadow-xl p-0" x-data="{ show_group: '{{$is_private_post}}' }">
                <div class="card-body">
                    ...
                    <div class="mt-2">
                        <div class="flex justify-start items-start " >
                            <div class="bg-white border-2 rounded border-gray-400 w-4 h-4 flex flex-shrink-0 justify-center items-center mr-2 focus-within:border-blue-500 ">
                                <input @click="show_group = show_group == '0' ? 1 : 0 " wire:model.defer='is_private_post' type="checkbox" class="checkbox checkbox-sm">
                    ...
                    <div class="w-full mt-4" x-show="show_group == 1 || show_group == 'true'">
                        <label for="groups">
                            Select Category/s
...
@push('js')
    ...
    <script type="module">
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ckeditorBuild("#description", @this.description);
            initializeSelectGroups();
            select_groups.val(@this.categories).trigger('change');
        });
